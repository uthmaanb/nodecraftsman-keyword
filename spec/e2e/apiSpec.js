...
const dbSession = require("../../src/backend/dbSession.js")
const Server = require("../../src/backend/server.js").Server
...
describe("The API", function () {
  ...
  it("should create a new keyword when recieving a POST request at /api/keywords/", function (done) {
    var expected = {
      _items: [
        { id: 1, value: "Aubergine", categoryID: 1 },
        { id: 2, value: "Onion", categoryID: 1 },
  ...
  it("should update a keyword when recieving a POST request at /api/keywords/:id/", function (done) {
    var expected = {
  ...
  it("should remove a keyword when recieving a DELETE request at /api/keywords/:id", function (done) {
    var expected = {
